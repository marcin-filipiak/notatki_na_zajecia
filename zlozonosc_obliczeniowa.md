# Notatka: Złożoność obliczeniowa algorytmów
...
### 2. Jak ocenia się złożoność obliczeniową?
...
### 3. Jak oblicza się złożoność obliczeniową?
...
### 4. Dlaczego złożoność obliczeniowa jest ważna?
...
## 2. Przykłady poziomów złożoności czasowej algorytmów
...
### 2. **Złożoność logarytmiczna: O(log n)**
...
### 4. **Złożoność liniowo-logarytmiczna: O(n log n)**
...
### 8. **Złożoność obliczeniowa O(m \* n)**
